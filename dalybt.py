...
class DalyBMSBluetooth(DalyBMS):
    ...
    async def get_cell_voltages(self, response_data=None):
        ...
        max_responses = self._calc_num_responses('cell_voltages', 3)
    ...
    async def get_temperatures(self, response_data=None):
        ...
        # Hack around something weird in the upstream lib
        return response_data[1]-40
        #return super().get_temperatures(response_data=bytes(response_data))
...
class DalyBMSConnection():
    ...
    async def update_cell_voltage_range(self):
        ...
        print(f"Cell v range: {cell_v_range}")
        self.data['cell_v_range'] = cell_v_range
